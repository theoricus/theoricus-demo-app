...
// TEMPLATES
(function() {__t('app').templates = { 'views/features/index/index': function (locals, attrs, escape, rethrow) {var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;var buf = [];with (locals || {}) {var interp;buf.push('<div');buf.push(attrs({ "class": ('features') }, {}));buf.push('><h1>FEATURES rendered! :)</h1><div');buf.push(attrs({ 'id':('feature') }, {}));buf.push('></div></div>');}return buf.join("");},'views/features/show/index': function (locals, attrs, escape, rethrow) {var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;var buf = [];with (locals || {}) {var interp;buf.push('<div');buf.push(attrs({ "class": ('feature') }, {}));buf.push('><h1>FEATURE # ' + escape((interp = data.feature_id) == null ? '' : interp) + ' rendered! :)</h1></div>');}return buf.join("");},'views/main/home/index': function (locals, attrs, escape, rethrow) {var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;var buf = [];with (locals || {}) {var interp;buf.push('<div');buf.push(attrs({ "class": ('home') }, {}));buf.push('><h1>HOME markup rendered! :)</h1><div');buf.push(attrs({ 'id':('features') }, {}));buf.push('></div></div>');}return buf.join("");},'views/main/index/index': function (locals, attrs, escape, rethrow) {var attrs = jade.attrs, escape = jade.escape, rethrow = jade.rethrow;var buf = [];with (locals || {}) {var interp;buf.push('<div');buf.push(attrs({ "class": ('header') }, {}));buf.push('><h1>I\'m the HEADER.</h1><div');buf.push(attrs({ "class": ('menu') }, {}));buf.push('><ul><li><a');buf.push(attrs({ 'href':('/main') }, {"href":true}));buf.push('>/main</a></li><li><a');buf.push(attrs({ 'href':('/home') }, {"href":true}));buf.push('>/home</a></li><li><a');buf.push(attrs({ 'href':('/features') }, {"href":true}));buf.push('>/features</a></li><li><a');buf.push(attrs({ 'href':('/feature/1') }, {"href":true}));buf.push('>/feature/1</a></li></ul></div></div><div');buf.push(attrs({ 'id':('main'), "class": ('main') }, {}));buf.push('><h1>I\'m the MAIN.</h1>');;(function(){  if ('number' == typeof data.lines.length) {    for (var i = 0, $l = data.lines.length; i < $l; i++) {      var item = data.lines[i];buf.push('<p>Item No ' + escape((interp = i) == null ? '' : interp) + '</p>');    }  } else {    for (var i in data.lines) {      var item = data.lines[i];buf.push('<p>Item No ' + escape((interp = i) == null ? '' : interp) + '</p>');   }  }}).call(this);buf.push('<div');buf.push(attrs({ 'id':('holder') }, {}));buf.push('></div></div><div');buf.push(attrs({ "class": ('footer') }, {}));buf.push('><h1>I\'m the FOOTER.</h1></div>');}return buf.join("");} };}).call( this );

// CONFIG
(function() {__t('app').config = {animate_at_startup: true,enable_auto_transitions: true};}).call( this );

// ROUTES
(function() {__t('app').routes = {'/main': {to: 'main/index',at: null,el: 'body'},'/home': {to: 'main/home',at: '/main',el: '#holder'},'/features': {to: 'features/index',at: '/main',el: '#holder'},'/feature/:feature_id': {to: 'features/show',at: '/features',el: '#feature'}};}).call( this );
...
(function() {
  ...
  */
  ...
  __t('app.controllers').FeaturesController = (function(_super) {

    __extends(FeaturesController, _super);

    function FeaturesController() {
      return FeaturesController.__super__.constructor.apply(this, arguments);
    }

    FeaturesController.prototype.show = function(id) {
  ...
  __t('app.models').FeaturesModel = (function(_super) {

    __extends(FeaturesModel, _super);

    function FeaturesModel() {
      return FeaturesModel.__super__.constructor.apply(this, arguments);
    }
  ...
  __t('app.models').MainModel = (function(_super) {
    ...
    MainModel.prototype.lines = [1, 2, 3, 4, 5];
  ...
  __t('app.views.features').IndexView = (function(_super) {
  ...
  __t('app.views.features').ShowView = (function(_super) {
  ...
  __t('app.views.main').HomeView = (function(_super) {
  ...
  __t('app.views.main').IndexView = (function(_super) {
    ...
    IndexView.prototype.set_triggers = function() {
      ...
      return this.el.find("a").click(function(ev) {
        _this.navigate($(ev.target).attr("href"));
  ...
  __t('theoricus.core').Factory = (function() {
    ...
    function Factory(the) {
      ...
      this.t_tmpl = "views/{ns}/{name}/index";
    }
